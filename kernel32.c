/*
  Name: DEX-OS 1.1 Beta Kernel Main file
  Copyright: 
...
\nVersion 1.1 build April 15 2007\n \
...
void dex32_startup()
{
    ...
    printf("DEX");
    textcolor(WHITE);
    printf("%-76s\n"," Extensible Operating System v.1.1 Beta project \"Chameleon\"");
    textcolor(WHITE);
    textbackground(BLACK);
    printf("BUILD April 15 2007\n");
    textbackground(BLACK);
